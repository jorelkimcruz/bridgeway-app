...
$msg_admin="";
	$select=mysql_query("SELECT * FROM tb_leave WHERE status='Decline'");
...
<div id="page-wrapper">
	<div id="page" class="container">
		<div class="title">
<a href="emp_admin_viewleave.php">[PENDING LEAVE]</a><a href="emp_admin_viewleaveACCEPT.php">[ACCEPTED LEAVE]</a>
