		...
		<div id="logo">
			...
			<div id="menu">
				<ul>
					...
					<li><a href="customer_index.php" accesskey="2" title="">My profile</a></li>
					<li><a href="#" accesskey="3" title="">Sign up</a></li>
					<li  class="current_page_item"><a href="search_product.php" accesskey="4" title="">Search Product</a></li>
...
<img src="../admin/upload/<?php echo $row[5];?>" alt="" width="200" height="250"/><br>
		<?php echo '<b>Name:</b> '.$row[1].'<br><b>Description: </b><br> '.$row[2].'
		<br><br><b>Price: </b>'.$row[4].'<br><b>Quantity: </b>'.$row[3].'<br>
		<b>Quantity to order:</b><select name="quantity" id="quantity2">';?>
		<?php 
		for($p=1; $p<=$row[3]; $p++){ ?>
		...
		<?php
		echo'</select><br>
		<a style="color: red" href="add_cart.php?id=">Add to cart
	</a></td>';
