...
if (isset($_SESSION['login_id'])) {
    if ($_SESSION['level']==2){
		...
		redirect_to('admin/as_admin_index.php');
	}
...
//var_dump($_POST['username']);
		...
		if ( empty($errors) ) {
			...
			if (mysql_num_rows($result_set) == 1) {
				...
				$_SESSION['login_id'] = $found_user['login_id'];
				...
				$audit_query="INSERT INTO tb_audit_trail values('','$login_id',CURRENT_TIMESTAMP,'Authentication','Login','Successful');";
...
<div class="wrapper">
	<div id="three-column" class="container">
		<div><span class="arrow-down"></span></div>
						...
						<center>
						<table><tr><td>User Name </td><td><input type = "text"  name= "username" >
						</td></tr><tr>
